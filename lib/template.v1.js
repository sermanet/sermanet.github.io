...
// Font configuration - change this variable to update fonts across the entire template
var FONT_FAMILY = 'HoeflerText-Regular, Cochin, Georgia, serif';
// Font size configuration - change these variables to update font sizes across the entire template
var FONT_SIZE = '8px';
var FONT_SIZE_LARGE = '10px';
var FONT_SIZE_BASE = '10px';
var FONT_SIZE_H1 = '20px';
var FONT_SIZE_H1_MEDIUM = '26px';
var FONT_SIZE_H1_LARGE = '30px';
var FONT_SIZE_H1_XLARGE = '36px';
var FONT_SIZE_H2 = '15px';
var FONT_SIZE_H2_LARGE = '15px';
var FONT_SIZE_H2_SUBTITLE = '20px';
var FONT_SIZE_H2_SUBTITLE_LARGE = '20px';
var FONT_SIZE_H3 = '15px';
var FONT_SIZE_H3_LARGE = '20px';
var FONT_SIZE_H4 = '14px';
var FONT_SIZE_PRE = '14px';
var FONT_SIZE_FIGCAPTION = '12px';
var FONT_SIZE_FIGCAPTION_LARGE = '13px';
var FONT_SIZE_EQUATION = '115%';
var FONT_SIZE_BYLINE = '18px';
var FONT_SIZE_APPENDIX = '14px';
var FONT_SIZE_APPENDIX_H3 = '16px';
var FONT_SIZE_APPENDIX_CITATION = '11px';
var FONT_SIZE_APPENDIX_REFERENCES = '12px';
var FONT_SIZE_HEADER = '16px';
var FONT_SIZE_HEADER_LOGO = '17px';
var FONT_SIZE_HEADER_NAV = '12px';
var FONT_SIZE_FOOTER_LOGO = '17px';
var FONT_SIZE_PROJECT_TITLE = '250%';
var FONT_SIZE_CITE = '75%';
var FONT_SIZE_CITE_NUMBER = '11px';
// Alternative fonts you can use:
// var FONT_FAMILY = '-apple-system, BlinkMacSystemFont, "Roboto", Helvetica, sans-serif'; // System fonts
// var FONT_FAMILY = 'Georgia, serif'; // Simple serif
// var FONT_FAMILY = 'Cochin, Georgia, serif'; // Elegant serif
...
var templateHTML = "\n<style>\n  dt-appendix {\n    display: block;\n    font-size: " + FONT_SIZE_APPENDIX + ";\n    line-height: 24px;\n    margin-bottom: 0;\n    border-top: 1px solid rgba(0,0,0,0.1);\n    color: rgba(0,0,0,0.5);\n    background: rgb(250, 250, 250);\n    padding-top: 36px;\n    padding-bottom: 60px;\n  }\n  dt-appendix h3 {\n    font-size: " + FONT_SIZE_APPENDIX_H3 + ";\n    font-weight: 500;\n    margin-top: 18px;\n    margin-bottom: 18px;\n    color: rgba(0,0,0,0.65);\n  }\n  dt-appendix .citation {\n    font-size: " + FONT_SIZE_APPENDIX_CITATION + ";\n    line-height: 15px;\n    border-left: 1px solid rgba(0, 0, 0, 0.1);\n    padding-left: 18px;\n    border: 1px solid rgba(0,0,0,0.1);\n    background: rgba(0, 0, 0, 0.02);\n    padding: 10px 18px;\n    border-radius: 3px;\n    color: rgba(150, 150, 150, 1);\n    overflow: hidden;\n    margin-top: -12px;\n  }\n  dt-appendix .references {\n    font-size: " + FONT_SIZE_APPENDIX_REFERENCES + ";\n    line-height: 20px;\n  }\n  dt-appendix a {\n    color: rgba(0, 0, 0, 0.6);\n  }\n  dt-appendix ol,\n  dt-appendix ul {\n    padding-left: 24px;\n  }\n</style>\n\n<div class=\"l-body\">\n</div>\n";
...
var html$4 = "\n<style>\ndt-header {\n  display: block;\n  position: relative;\n  height: 60px;\n  background-color: hsl(200, 60%, 15%);\n  width: 100%;\n  box-sizing: border-box;\n  z-index: 2;\n  color: rgba(0, 0, 0, 0.8);\n  border-bottom: 1px solid rgba(0, 0, 0, 0.08);\n  box-shadow: 0 1px 6px rgba(0, 0, 0, 0.05);\n}\ndt-header .content {\n  height: 70px;\n}\ndt-header a {\n  font-size: " + FONT_SIZE_HEADER + ";\n  height: 60px;\n  line-height: 60px;\n  text-decoration: none;\n  color: rgba(255, 255, 255, 0.8);\n  padding: 22px 0;\n}\ndt-header a:hover {\n  color: rgba(255, 255, 255, 1);\n}\ndt-header svg {\n  width: 24px;\n  position: relative;\n  top: 4px;\n  margin-right: 2px;\n}\n@media(min-width: 1080px) {\n  dt-header {\n    height: 70px;\n  }\n  dt-header a {\n    height: 70px;\n    line-height: 70px;\n    padding: 28px 0;\n  }\n  dt-header .logo {\n  }\n}\ndt-header svg path {\n  fill: none;\n  stroke: rgba(255, 255, 255, 0.8);\n  stroke-width: 3px;\n}\ndt-header .logo {\n  font-size: " + FONT_SIZE_HEADER_LOGO + ";\n  font-weight: 200;\n}\ndt-header .nav {\n  float: right;\n  font-weight: 300;\n}\ndt-header .nav a {\n  font-size: " + FONT_SIZE_HEADER_NAV + ";\n  margin-left: 24px;\n  text-transform: uppercase;\n}\n</style>\n\n<div class=\"content l-page\">\n  <a href=\"/\" class=\"logo\">\n    " + logo + "\n    Distill\n  </a>\n  <div class=\"nav\">\n    <a href=\"/about/\">About</a>\n    <a href=\"/prize/\">Prize</a>\n    <a href=\"/journal/\">Submit</a>\n  </div>\n</div>\n";
